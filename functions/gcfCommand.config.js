var GCF_URL  = process.env.GCF_URL ? process.env.GCF_URL : "https://us-central1-clean-abode-183720.cloudfunctions.net/hyperflow_executor";
//var GCF_URL  = process.env.GCF_URL ? process.env.GCF_URL :  'http://localhost:2000'

var GOOGLE_BUCKET = process.env.GOOGLE_BUCKET ? process.env.GOOGLE_BUCKET : "mf57testcloudstorage";
